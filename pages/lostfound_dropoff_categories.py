...
class FoundDropoffForm(tk.Canvas):
    ...
    def submit_form(self):
        ...
        self.root.memory['lost_and_found_dropoff']['item_category'] = item_category
        self.root.memory['lost_and_found_dropoff']['item_subcategory'] = item_subcategory
        self.root.memory['lost_and_found_dropoff']['item_detail'] = item_detail
